...
import 'package:fantasy/screens/selectteamname.dart';
...
class FantasyScreen extends StatelessWidget {
    ...
    return  BlocProvider(
      ...
      child: BlocConsumer<FantasyCubit,FantasyStates>(
        ...
        builder:(context,state){
            FantasyCubit.get(context).getManagerData();
            return SafeArea(
              child: Scaffold(
                body: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if(MyShared.getData(key: 'uId')!=null&&FantasyCubit.get(context).manager.team!=null)
                        Column(
                          children: [
                            Padding(
                      ...
                      if(FantasyCubit.get(context).manager.team==null)
                        pickTeam(context: context)
  ...
  Widget pickTeam({required BuildContext context}){
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
                ...
                onPressed: (){
                  Navigator.of(context).push(MaterialPageRoute(builder: (context) => const SelectTeamName(),));
                }, child: const Text("PickTeam")),
            const SizedBox(height: 15,)
          ],),
      ),
    );
